...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e95:	75 3c                	jne    800ed3 <set_pgfault_handler+0x4b>
		// First time through!
  ...
  800eb9:	78 20                	js     800edb <set_pgfault_handler+0x53>
			return;
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800ebb:	a1 04 20 80 00       	mov    0x802004,%eax
  800ec0:	8b 40 48             	mov    0x48(%eax),%eax
  800ec3:	c7 44 24 04 dd 0e 80 	movl   $0x800edd,0x4(%esp)
  800eca:	00 
  800ecb:	89 04 24             	mov    %eax,(%esp)
  800ece:	e8 ed fe ff ff       	call   800dc0 <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  800ede:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
