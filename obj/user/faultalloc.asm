...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800eb5:	75 3c                	jne    800ef3 <set_pgfault_handler+0x4b>
		// First time through!
  ...
  800ed9:	78 20                	js     800efb <set_pgfault_handler+0x53>
			return;
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800edb:	a1 04 20 80 00       	mov    0x802004,%eax
  800ee0:	8b 40 48             	mov    0x48(%eax),%eax
  800ee3:	c7 44 24 04 fd 0e 80 	movl   $0x800efd,0x4(%esp)
  800eea:	00 
  800eeb:	89 04 24             	mov    %eax,(%esp)
  800eee:	e8 ed fe ff ff       	call   800de0 <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  800efe:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
