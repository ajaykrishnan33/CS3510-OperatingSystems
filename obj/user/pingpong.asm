...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 2c             	sub    $0x2c,%esp
	...
	if ((who = fork()) != 0) {
  80003c:	e8 f0 0e 00 00       	call   800f31 <fork>
  ...
  80004d:	eb 3e                	jmp    80008d <umain+0x5a>
{
  ...
  800086:	e8 4d 11 00 00       	call   8011d8 <ipc_send>
  ...
  8000a0:	e8 cb 10 00 00       	call   801170 <ipc_recv>
  ...
  8000bb:	c7 04 24 16 16 80 00 	movl   $0x801616,(%esp)
  ...
  8000e9:	e8 ea 10 00 00       	call   8011d8 <ipc_send>
		if (i == 10)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028f:	e8 cc 10 00 00       	call   801360 <__udivdi3>
  ...
  8002ef:	e8 9c 11 00 00       	call   801490 <__umoddi3>
  8002f4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002f8:	0f be 80 33 16 80 00 	movsbl 0x801633(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800413:	ff 24 8d 00 17 80 00 	jmp    *0x801700(,%ecx,4)
  ...
  8004df:	c7 44 24 08 54 16 80 	movl   $0x801654,0x8(%esp)
  8004e6:	00 
  ...
  800511:	b8 44 16 80 00       	mov    $0x801644,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800be0:	00 
  800be1:	c7 44 24 08 88 18 80 	movl   $0x801888,0x8(%esp)
  800be8:	00 
  800be9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf0:	00 
  800bf1:	c7 04 24 a5 18 80 00 	movl   $0x8018a5,(%esp)
  800bf8:	e8 85 06 00 00       	call   801282 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c72:	00 
  800c73:	c7 44 24 08 88 18 80 	movl   $0x801888,0x8(%esp)
  800c7a:	00 
  800c7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c82:	00 
  800c83:	c7 04 24 a5 18 80 00 	movl   $0x8018a5,(%esp)
  800c8a:	e8 f3 05 00 00       	call   801282 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cc5:	00 
  800cc6:	c7 44 24 08 88 18 80 	movl   $0x801888,0x8(%esp)
  800ccd:	00 
  800cce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd5:	00 
  800cd6:	c7 04 24 a5 18 80 00 	movl   $0x8018a5,(%esp)
  800cdd:	e8 a0 05 00 00       	call   801282 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d18:	00 
  800d19:	c7 44 24 08 88 18 80 	movl   $0x801888,0x8(%esp)
  800d20:	00 
  800d21:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d28:	00 
  800d29:	c7 04 24 a5 18 80 00 	movl   $0x8018a5,(%esp)
  800d30:	e8 4d 05 00 00       	call   801282 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d6b:	00 
  800d6c:	c7 44 24 08 88 18 80 	movl   $0x801888,0x8(%esp)
  800d73:	00 
  800d74:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d7b:	00 
  800d7c:	c7 04 24 a5 18 80 00 	movl   $0x8018a5,(%esp)
  800d83:	e8 fa 04 00 00       	call   801282 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dbe:	00 
  800dbf:	c7 44 24 08 88 18 80 	movl   $0x801888,0x8(%esp)
  800dc6:	00 
  800dc7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dce:	00 
  800dcf:	c7 04 24 a5 18 80 00 	movl   $0x8018a5,(%esp)
  800dd6:	e8 a7 04 00 00       	call   801282 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e33:	00 
  800e34:	c7 44 24 08 88 18 80 	movl   $0x801888,0x8(%esp)
  800e3b:	00 
  800e3c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e43:	00 
  800e44:	c7 04 24 a5 18 80 00 	movl   $0x8018a5,(%esp)
  800e4b:	e8 32 04 00 00       	call   801282 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e6d:	c1 eb 0c             	shr    $0xc,%ebx
  800e70:	8b 0c 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%ecx
  800e77:	f6 c5 08             	test   $0x8,%ch
  800e7a:	75 3c                	jne    800eb8 <pgfault+0x60>
		cprintf("%x, %d, %lld\n", addr, err&FEC_U, PGNUM(addr));
  800e7c:	89 d1                	mov    %edx,%ecx
  800e7e:	c1 e9 0c             	shr    $0xc,%ecx
  800e81:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  800e85:	83 e0 04             	and    $0x4,%eax
  800e88:	89 44 24 08          	mov    %eax,0x8(%esp)
  800e8c:	89 54 24 04          	mov    %edx,0x4(%esp)
  800e90:	c7 04 24 b3 18 80 00 	movl   $0x8018b3,(%esp)
  800e97:	e8 5e f3 ff ff       	call   8001fa <cprintf>
		panic("Either not COW page or error not during write.");
  800e9c:	c7 44 24 08 24 19 80 	movl   $0x801924,0x8(%esp)
  800ea3:	00 
  800ea4:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  800eab:	00 
  800eac:	c7 04 24 c1 18 80 00 	movl   $0x8018c1,(%esp)
  800eb3:	e8 ca 03 00 00       	call   801282 <_panic>
	// Hint:
  ...
  800ed2:	e8 6c fd ff ff       	call   800c43 <sys_page_alloc>
	memmove((void*)PFTEMP, pg_addr, PGSIZE);
  800ed7:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800ede:	00 
  800edf:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800ee3:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800eea:	e8 d5 fa ff ff       	call   8009c4 <memmove>
	sys_page_map(0, (void*)PFTEMP, 0, pg_addr, PTE_U|PTE_P|PTE_W);
  800eef:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800ef6:	00 
  800ef7:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  ...
  800f12:	e8 80 fd ff ff       	call   800c97 <sys_page_map>
	sys_page_unmap(0, (void*)PFTEMP);
  800f17:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f1e:	00 
  800f1f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800f26:	e8 bf fd ff ff       	call   800cea <sys_page_unmap>

}
  800f2b:	83 c4 24             	add    $0x24,%esp
  800f2e:	5b                   	pop    %ebx
  800f2f:	5d                   	pop    %ebp
  800f30:	c3                   	ret    
...
fork(void)
{
  ...
  800f35:	56                   	push   %esi
  800f36:	53                   	push   %ebx
  800f37:	83 ec 3c             	sub    $0x3c,%esp
	// LAB 4: Your code here.
		
	set_pgfault_handler(pgfault);
  800f3a:	c7 04 24 58 0e 80 00 	movl   $0x800e58,(%esp)
  800f41:	e8 92 03 00 00       	call   8012d8 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800f55:	0f 8e be 01 00 00    	jle    801119 <fork+0x1e8>
  ...
  800f6e:	0f 84 ef 00 00 00    	je     801063 <fork+0x132>
	            continue;

	        for (j=0;j<NPTENTRIES;j++) 
	        {
	            unsigned pn = (i << 10) | j;
  800f74:	8b 45 dc             	mov    -0x24(%ebp),%eax
  800f77:	c1 e0 0a             	shl    $0xa,%eax
  800f7a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800f7d:	bb 00 00 00 00       	mov    $0x0,%ebx
  800f82:	8b 75 e4             	mov    -0x1c(%ebp),%esi
  800f85:	09 de                	or     %ebx,%esi
	            if (pn == PGNUM(UXSTACKTOP - PGSIZE)) {
  800f87:	81 fe ff eb 0e 00    	cmp    $0xeebff,%esi
  800f8d:	0f 84 c1 00 00 00    	je     801054 <fork+0x123>
	                continue;
	            }
  ...
  800f9c:	0f 84 b2 00 00 00    	je     801054 <fork+0x123>
	// uvpt+pn==(0xef401000){
	// 	cprintf("\n\nHERE\n\n");
	...
	if(pn==979969)
  800fa2:	81 fe 01 f4 0e 00    	cmp    $0xef401,%esi
  800fa8:	75 0c                	jne    800fb6 <fork+0x85>
		cprintf("\n\nHAHA\n\n");
  800faa:	c7 04 24 cc 18 80 00 	movl   $0x8018cc,(%esp)
  800fb1:	e8 44 f2 ff ff       	call   8001fa <cprintf>
  ...
  800fc5:	19 ff                	sbb    %edi,%edi
  800fc7:	81 e7 00 f8 ff ff    	and    $0xfffff800,%edi
  800fcd:	81 c7 05 08 00 00    	add    $0x805,%edi
  ...
  800fd6:	89 7c 24 10          	mov    %edi,0x10(%esp)
  ...
  800ff0:	e8 a2 fc ff ff       	call   800c97 <sys_page_map>
  800ff5:	85 c0                	test   %eax,%eax
  800ff7:	79 1c                	jns    801015 <fork+0xe4>
		panic("ERROR in page map system call.");
  800ff9:	c7 44 24 08 54 19 80 	movl   $0x801954,0x8(%esp)
  801000:	00 
  801001:	c7 44 24 04 54 00 00 	movl   $0x54,0x4(%esp)
  801008:	00 
  801009:	c7 04 24 c1 18 80 00 	movl   $0x8018c1,(%esp)
  801010:	e8 6d 02 00 00       	call   801282 <_panic>

	if(sys_page_map(envid, (void*)(pn*PGSIZE), 0, (void*)(pn*PGSIZE), perm))
  801015:	89 7c 24 10          	mov    %edi,0x10(%esp)
  801019:	89 74 24 0c          	mov    %esi,0xc(%esp)
  80101d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  801024:	00 
  801025:	89 74 24 04          	mov    %esi,0x4(%esp)
  801029:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80102c:	89 04 24             	mov    %eax,(%esp)
  80102f:	e8 63 fc ff ff       	call   800c97 <sys_page_map>
  801034:	85 c0                	test   %eax,%eax
  801036:	74 1c                	je     801054 <fork+0x123>
		panic("ERROR in page map system call.");
  801038:	c7 44 24 08 54 19 80 	movl   $0x801954,0x8(%esp)
  80103f:	00 
  801040:	c7 44 24 04 57 00 00 	movl   $0x57,0x4(%esp)
  801047:	00 
  801048:	c7 04 24 c1 18 80 00 	movl   $0x8018c1,(%esp)
  80104f:	e8 2e 02 00 00       	call   801282 <_panic>
	    {
	        // No page table yet.
	        if (!(uvpd[i] & PTE_P))
	            continue;
	        ...
	        for (j=0;j<NPTENTRIES;j++) 
  801054:	83 c3 01             	add    $0x1,%ebx
  801057:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
  80105d:	0f 85 1f ff ff ff    	jne    800f82 <fork+0x51>
	envid_t pid = sys_exofork();
	...
	if(pid>0)		//parent
	{
		int i,j;
	    for (i=0;i<PDX(UTOP);i++) 
  801063:	83 45 dc 01          	addl   $0x1,-0x24(%ebp)
  801067:	81 7d dc bb 03 00 00 	cmpl   $0x3bb,-0x24(%ebp)
  80106e:	0f 85 ee fe ff ff    	jne    800f62 <fork+0x31>
	            if (uvpt[pn] & PTE_P)
	                duppage(pid, pn);
	        }
	    }
  ...
  801074:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  80107b:	00 
  80107c:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801083:	ee 
  801084:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801087:	89 04 24             	mov    %eax,(%esp)
  80108a:	e8 b4 fb ff ff       	call   800c43 <sys_page_alloc>
  80108f:	85 c0                	test   %eax,%eax
  801091:	79 1c                	jns    8010af <fork+0x17e>
	    	panic("fork: no phys mem for xstk");
  801093:	c7 44 24 08 d5 18 80 	movl   $0x8018d5,0x8(%esp)
  80109a:	00 
  80109b:	c7 44 24 04 8b 00 00 	movl   $0x8b,0x4(%esp)
  8010a2:	00 
  8010a3:	c7 04 24 c1 18 80 00 	movl   $0x8018c1,(%esp)
  8010aa:	e8 d3 01 00 00       	call   801282 <_panic>
  ...
  8010b4:	8b 40 64             	mov    0x64(%eax),%eax
  8010b7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010bb:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8010be:	89 04 24             	mov    %eax,(%esp)
  8010c1:	e8 ca fc ff ff       	call   800d90 <sys_env_set_pgfault_upcall>
  8010c6:	85 c0                	test   %eax,%eax
  8010c8:	74 1c                	je     8010e6 <fork+0x1b5>
	        panic("fork: cannot set pgfault upcall");
  8010ca:	c7 44 24 08 74 19 80 	movl   $0x801974,0x8(%esp)
  8010d1:	00 
  8010d2:	c7 44 24 04 8f 00 00 	movl   $0x8f,0x4(%esp)
  8010d9:	00 
  8010da:	c7 04 24 c1 18 80 00 	movl   $0x8018c1,(%esp)
  8010e1:	e8 9c 01 00 00       	call   801282 <_panic>

	    // Step 5: set child status to ENV_RUNNABLE.
	    if (sys_env_set_status(pid, ENV_RUNNABLE))
  8010e6:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  8010ed:	00 
  8010ee:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8010f1:	89 04 24             	mov    %eax,(%esp)
  8010f4:	e8 44 fc ff ff       	call   800d3d <sys_env_set_status>
  8010f9:	85 c0                	test   %eax,%eax
  8010fb:	74 3a                	je     801137 <fork+0x206>
	        panic("fork: cannot set env status");
  8010fd:	c7 44 24 08 f0 18 80 	movl   $0x8018f0,0x8(%esp)
  801104:	00 
  801105:	c7 44 24 04 93 00 00 	movl   $0x93,0x4(%esp)
  80110c:	00 
  80110d:	c7 04 24 c1 18 80 00 	movl   $0x8018c1,(%esp)
  801114:	e8 69 01 00 00       	call   801282 <_panic>
	    return pid;
  ...
  801119:	e8 e7 fa ff ff       	call   800c05 <sys_getenvid>
		thisenv = &envs[ENVX(self_id)];		
  80111e:	25 ff 03 00 00       	and    $0x3ff,%eax
  801123:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801126:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80112b:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
  801130:	b8 00 00 00 00       	mov    $0x0,%eax
  801135:	eb 03                	jmp    80113a <fork+0x209>
	    ...
	    return pid;
  801137:	8b 45 d8             	mov    -0x28(%ebp),%eax
		return 0;
	}
...
sfork(void)
{
  ...
  801148:	c7 44 24 08 0c 19 80 	movl   $0x80190c,0x8(%esp)
  80114f:	00 
  801150:	c7 44 24 04 a7 00 00 	movl   $0xa7,0x4(%esp)
  801157:	00 
  801158:	c7 04 24 c1 18 80 00 	movl   $0x8018c1,(%esp)
  80115f:	e8 1e 01 00 00       	call   801282 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801181:	85 c0                	test   %eax,%eax
		pg = (void*)UTOP;
  801183:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801188:	0f 44 c2             	cmove  %edx,%eax

	int ret = sys_ipc_recv(pg);
  80118b:	89 04 24             	mov    %eax,(%esp)
  80118e:	e8 73 fc ff ff       	call   800e06 <sys_ipc_recv>

	if(ret<0)
  801193:	85 c0                	test   %eax,%eax
  801195:	79 16                	jns    8011ad <ipc_recv+0x3d>
	{
		if(from_env_store!=NULL)
  801197:	85 f6                	test   %esi,%esi
  801199:	74 06                	je     8011a1 <ipc_recv+0x31>
			*from_env_store = 0;
  80119b:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store!=NULL)
  8011a1:	85 db                	test   %ebx,%ebx
  8011a3:	74 2c                	je     8011d1 <ipc_recv+0x61>
			*perm_store = 0;
  8011a5:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8011ab:	eb 24                	jmp    8011d1 <ipc_recv+0x61>
		return ret;
	}

	if(from_env_store!=NULL)
  8011ad:	85 f6                	test   %esi,%esi
  8011af:	74 0a                	je     8011bb <ipc_recv+0x4b>
		*from_env_store = thisenv->env_ipc_from;
  8011b1:	a1 04 20 80 00       	mov    0x802004,%eax
  8011b6:	8b 40 74             	mov    0x74(%eax),%eax
  8011b9:	89 06                	mov    %eax,(%esi)
	if(perm_store!=NULL)
  8011bb:	85 db                	test   %ebx,%ebx
  8011bd:	74 0a                	je     8011c9 <ipc_recv+0x59>
		*perm_store = thisenv->env_ipc_perm;
  8011bf:	a1 04 20 80 00       	mov    0x802004,%eax
  8011c4:	8b 40 78             	mov    0x78(%eax),%eax
  8011c7:	89 03                	mov    %eax,(%ebx)

	return thisenv->env_ipc_value;
  8011c9:	a1 04 20 80 00       	mov    0x802004,%eax
  8011ce:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8011ec:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  8011f1:	0f 44 d8             	cmove  %eax,%ebx
	while(1)
	{
  ...
  801206:	e8 d8 fb ff ff       	call   800de3 <sys_ipc_try_send>
		if(ret<0 && ret!=-E_IPC_NOT_RECV)
  80120b:	83 f8 f8             	cmp    $0xfffffff8,%eax
  80120e:	74 25                	je     801235 <ipc_send+0x5d>
  801210:	89 c2                	mov    %eax,%edx
  801212:	c1 ea 1f             	shr    $0x1f,%edx
  801215:	84 d2                	test   %dl,%dl
  801217:	74 1c                	je     801235 <ipc_send+0x5d>
			panic("Some other error in ipc send.");
  801219:	c7 44 24 08 94 19 80 	movl   $0x801994,0x8(%esp)
  801220:	00 
  801221:	c7 44 24 04 44 00 00 	movl   $0x44,0x4(%esp)
  801228:	00 
  801229:	c7 04 24 b2 19 80 00 	movl   $0x8019b2,(%esp)
  801230:	e8 4d 00 00 00       	call   801282 <_panic>
		else
		if(ret==0)
  801235:	85 c0                	test   %eax,%eax
  801237:	74 09                	je     801242 <ipc_send+0x6a>
			return;
		sys_yield();
  801239:	e8 e6 f9 ff ff       	call   800c24 <sys_yield>
	}
  80123e:	66 90                	xchg   %ax,%ax
  801240:	eb b2                	jmp    8011f4 <ipc_send+0x1c>
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801263:	75 0d                	jne    801272 <ipc_find_env+0x28>
			return envs[i].env_id;
  801265:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801268:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  80126d:	8b 40 40             	mov    0x40(%eax),%eax
  801270:	eb 0e                	jmp    801280 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  80127a:	75 d9                	jne    801255 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  80127c:	66 b8 00 00          	mov    $0x0,%ax
}
  801280:	5d                   	pop    %ebp
  801281:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801287:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  80128a:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80128d:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801293:	e8 6d f9 ff ff       	call   800c05 <sys_getenvid>
  801298:	8b 55 0c             	mov    0xc(%ebp),%edx
  80129b:	89 54 24 10          	mov    %edx,0x10(%esp)
  80129f:	8b 55 08             	mov    0x8(%ebp),%edx
  8012a2:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8012a6:	89 74 24 08          	mov    %esi,0x8(%esp)
  8012aa:	89 44 24 04          	mov    %eax,0x4(%esp)
  8012ae:	c7 04 24 bc 19 80 00 	movl   $0x8019bc,(%esp)
  8012b5:	e8 40 ef ff ff       	call   8001fa <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8012ba:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8012be:	8b 45 10             	mov    0x10(%ebp),%eax
  8012c1:	89 04 24             	mov    %eax,(%esp)
  8012c4:	e8 d0 ee ff ff       	call   800199 <vcprintf>
	cprintf("\n");
  8012c9:	c7 04 24 d3 18 80 00 	movl   $0x8018d3,(%esp)
  8012d0:	e8 25 ef ff ff       	call   8001fa <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8012d5:	cc                   	int3   
  8012d6:	eb fd                	jmp    8012d5 <_panic+0x53>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8012de:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  8012e5:	75 3c                	jne    801323 <set_pgfault_handler+0x4b>
		// First time through!
		// LAB 4: Your code here.
		if(sys_page_alloc(thisenv->env_id, (void*)(UXSTACKTOP-PGSIZE), PTE_U|PTE_P|PTE_W) < 0)
  8012e7:	a1 04 20 80 00       	mov    0x802004,%eax
  ...
  801302:	e8 3c f9 ff ff       	call   800c43 <sys_page_alloc>
  801307:	85 c0                	test   %eax,%eax
  801309:	78 20                	js     80132b <set_pgfault_handler+0x53>
			return;
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  80130b:	a1 04 20 80 00       	mov    0x802004,%eax
  801310:	8b 40 48             	mov    0x48(%eax),%eax
  801313:	c7 44 24 04 2d 13 80 	movl   $0x80132d,0x4(%esp)
  80131a:	00 
  80131b:	89 04 24             	mov    %eax,(%esp)
  80131e:	e8 6d fa ff ff       	call   800d90 <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  80132e:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  801351:	5c                   	pop    %esp
	...
	// LAB 4: Your code here.
  801352:	c3                   	ret    
  801353:	66 90                	xchg   %ax,%ax
  801355:	66 90                	xchg   %ax,%ax
