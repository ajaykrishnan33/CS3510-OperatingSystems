...
sys_env_destroy(envid_t envid)
{
  ...
  800bb8:	e8 75 03 00 00       	call   800f32 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c4a:	e8 e3 02 00 00       	call   800f32 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c9d:	e8 90 02 00 00       	call   800f32 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cf0:	e8 3d 02 00 00       	call   800f32 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d43:	e8 ea 01 00 00       	call   800f32 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d96:	e8 97 01 00 00       	call   800f32 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e0b:	e8 22 01 00 00       	call   800f32 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800e31:	85 c0                	test   %eax,%eax
		pg = (void*)UTOP;
  800e33:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800e9c:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  ...
  800ebb:	83 f8 f8             	cmp    $0xfffffff8,%eax
  800ebe:	74 25                	je     800ee5 <ipc_send+0x5d>
  800ec0:	89 c2                	mov    %eax,%edx
  800ec2:	c1 ea 1f             	shr    $0x1f,%edx
  800ec5:	84 d2                	test   %dl,%dl
  800ec7:	74 1c                	je     800ee5 <ipc_send+0x5d>
			panic("Some other error in ipc send.");
  800ec9:	c7 44 24 08 d3 14 80 	movl   $0x8014d3,0x8(%esp)
  800ed0:	00 
  800ed1:	c7 44 24 04 44 00 00 	movl   $0x44,0x4(%esp)
  800ed8:	00 
  800ed9:	c7 04 24 f1 14 80 00 	movl   $0x8014f1,(%esp)
  800ee0:	e8 4d 00 00 00       	call   800f32 <_panic>
		else
		if(ret==0)
  800ee5:	85 c0                	test   %eax,%eax
  800ee7:	74 09                	je     800ef2 <ipc_send+0x6a>
			return;
		sys_yield();
  800ee9:	e8 f6 fc ff ff       	call   800be4 <sys_yield>
	}
  800eee:	66 90                	xchg   %ax,%ax
  800ef0:	eb b2                	jmp    800ea4 <ipc_send+0x1c>
}
...
ipc_find_env(enum EnvType type)
{
  ...
  800f13:	75 0d                	jne    800f22 <ipc_find_env+0x28>
			return envs[i].env_id;
  800f15:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800f18:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  800f1d:	8b 40 40             	mov    0x40(%eax),%eax
  800f20:	eb 0e                	jmp    800f30 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800f25:	3d 00 04 00 00       	cmp    $0x400,%eax
  800f2a:	75 d9                	jne    800f05 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  800f2c:	66 b8 00 00          	mov    $0x0,%ax
}
  800f30:	5d                   	pop    %ebp
  800f31:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f37:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800f3a:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800f3d:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800f43:	e8 7d fc ff ff       	call   800bc5 <sys_getenvid>
  800f48:	8b 55 0c             	mov    0xc(%ebp),%edx
  800f4b:	89 54 24 10          	mov    %edx,0x10(%esp)
  800f4f:	8b 55 08             	mov    0x8(%ebp),%edx
  800f52:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800f56:	89 74 24 08          	mov    %esi,0x8(%esp)
  800f5a:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f5e:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  800f65:	e8 57 f2 ff ff       	call   8001c1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f6a:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f6e:	8b 45 10             	mov    0x10(%ebp),%eax
  800f71:	89 04 24             	mov    %eax,(%esp)
  800f74:	e8 e7 f1 ff ff       	call   800160 <vcprintf>
	cprintf("\n");
  800f79:	c7 04 24 2f 12 80 00 	movl   $0x80122f,(%esp)
  800f80:	e8 3c f2 ff ff       	call   8001c1 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800f85:	cc                   	int3   
  800f86:	eb fd                	jmp    800f85 <_panic+0x53>
