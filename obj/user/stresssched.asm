...
umain(int argc, char **argv)
{
  ...
  80004f:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800054:	e8 38 0f 00 00       	call   800f91 <fork>
  ...
  8000cf:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  8000d6:	00 
  8000d7:	c7 44 24 04 21 00 00 	movl   $0x21,0x4(%esp)
  8000de:	00 
  8000df:	c7 04 24 08 15 80 00 	movl   $0x801508,(%esp)
  ...
  8000fe:	c7 04 24 1b 15 80 00 	movl   $0x80151b,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800199:	c7 04 24 44 15 80 00 	movl   $0x801544,(%esp)
  ...
  8001af:	e8 51 00 00 00       	call   800205 <vcprintf>
	cprintf("\n");
  8001b4:	c7 04 24 f3 17 80 00 	movl   $0x8017f3,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ef:	e8 4c 0f 00 00       	call   801240 <__udivdi3>
  ...
  80034f:	e8 1c 10 00 00       	call   801370 <__umoddi3>
  800354:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800358:	0f be 80 67 15 80 00 	movsbl 0x801567(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800473:	ff 24 8d 20 16 80 00 	jmp    *0x801620(,%ecx,4)
  ...
  80053f:	c7 44 24 08 88 15 80 	movl   $0x801588,0x8(%esp)
  800546:	00 
  ...
  800571:	b8 78 15 80 00       	mov    $0x801578,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c40:	00 
  800c41:	c7 44 24 08 a8 17 80 	movl   $0x8017a8,0x8(%esp)
  800c48:	00 
  800c49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c50:	00 
  800c51:	c7 04 24 c5 17 80 00 	movl   $0x8017c5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cd2:	00 
  800cd3:	c7 44 24 08 a8 17 80 	movl   $0x8017a8,0x8(%esp)
  800cda:	00 
  800cdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce2:	00 
  800ce3:	c7 04 24 c5 17 80 00 	movl   $0x8017c5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d25:	00 
  800d26:	c7 44 24 08 a8 17 80 	movl   $0x8017a8,0x8(%esp)
  800d2d:	00 
  800d2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d35:	00 
  800d36:	c7 04 24 c5 17 80 00 	movl   $0x8017c5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d78:	00 
  800d79:	c7 44 24 08 a8 17 80 	movl   $0x8017a8,0x8(%esp)
  800d80:	00 
  800d81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d88:	00 
  800d89:	c7 04 24 c5 17 80 00 	movl   $0x8017c5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dcb:	00 
  800dcc:	c7 44 24 08 a8 17 80 	movl   $0x8017a8,0x8(%esp)
  800dd3:	00 
  800dd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ddb:	00 
  800ddc:	c7 04 24 c5 17 80 00 	movl   $0x8017c5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e1e:	00 
  800e1f:	c7 44 24 08 a8 17 80 	movl   $0x8017a8,0x8(%esp)
  800e26:	00 
  800e27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e2e:	00 
  800e2f:	c7 04 24 c5 17 80 00 	movl   $0x8017c5,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e93:	00 
  800e94:	c7 44 24 08 a8 17 80 	movl   $0x8017a8,0x8(%esp)
  800e9b:	00 
  800e9c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ea3:	00 
  800ea4:	c7 04 24 c5 17 80 00 	movl   $0x8017c5,(%esp)
...
pgfault(struct UTrapframe *utf)
{
  ...
  800ecd:	c1 eb 0c             	shr    $0xc,%ebx
  800ed0:	8b 0c 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%ecx
  800ed7:	f6 c5 08             	test   $0x8,%ch
  800eda:	75 3c                	jne    800f18 <pgfault+0x60>
		cprintf("%x, %d, %lld\n", addr, err&FEC_U, PGNUM(addr));
  800edc:	89 d1                	mov    %edx,%ecx
  800ede:	c1 e9 0c             	shr    $0xc,%ecx
  800ee1:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  800ee5:	83 e0 04             	and    $0x4,%eax
  800ee8:	89 44 24 08          	mov    %eax,0x8(%esp)
  800eec:	89 54 24 04          	mov    %edx,0x4(%esp)
  800ef0:	c7 04 24 d3 17 80 00 	movl   $0x8017d3,(%esp)
  800ef7:	e8 6a f3 ff ff       	call   800266 <cprintf>
		panic("Either not COW page or error not during write.");
  800efc:	c7 44 24 08 44 18 80 	movl   $0x801844,0x8(%esp)
  800f03:	00 
  800f04:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  800f0b:	00 
  800f0c:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  800f13:	e8 55 f2 ff ff       	call   80016d <_panic>
	// Hint:
  ...
  800f32:	e8 6c fd ff ff       	call   800ca3 <sys_page_alloc>
	memmove((void*)PFTEMP, pg_addr, PGSIZE);
  800f37:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800f3e:	00 
  800f3f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f43:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800f4a:	e8 d5 fa ff ff       	call   800a24 <memmove>
	sys_page_map(0, (void*)PFTEMP, 0, pg_addr, PTE_U|PTE_P|PTE_W);
  800f4f:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800f56:	00 
  800f57:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  ...
  800f72:	e8 80 fd ff ff       	call   800cf7 <sys_page_map>
	sys_page_unmap(0, (void*)PFTEMP);
  800f77:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f7e:	00 
  800f7f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800f86:	e8 bf fd ff ff       	call   800d4a <sys_page_unmap>

}
  800f8b:	83 c4 24             	add    $0x24,%esp
  800f8e:	5b                   	pop    %ebx
  800f8f:	5d                   	pop    %ebp
  800f90:	c3                   	ret    
...
fork(void)
{
  ...
  800f95:	56                   	push   %esi
  800f96:	53                   	push   %ebx
  800f97:	83 ec 3c             	sub    $0x3c,%esp
	// LAB 4: Your code here.
		
	set_pgfault_handler(pgfault);
  800f9a:	c7 04 24 b8 0e 80 00 	movl   $0x800eb8,(%esp)
  800fa1:	e8 1e 02 00 00       	call   8011c4 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800fa6:	b8 07 00 00 00       	mov    $0x7,%eax
  800fab:	cd 30                	int    $0x30
  800fad:	89 45 d8             	mov    %eax,-0x28(%ebp)
  ...
  800fb5:	0f 8e be 01 00 00    	jle    801179 <fork+0x1e8>
  ...
  800fce:	0f 84 ef 00 00 00    	je     8010c3 <fork+0x132>
	            continue;

	        for (j=0;j<NPTENTRIES;j++) 
	        {
	            unsigned pn = (i << 10) | j;
  800fd4:	8b 45 dc             	mov    -0x24(%ebp),%eax
  800fd7:	c1 e0 0a             	shl    $0xa,%eax
  800fda:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800fdd:	bb 00 00 00 00       	mov    $0x0,%ebx
  800fe2:	8b 75 e4             	mov    -0x1c(%ebp),%esi
  800fe5:	09 de                	or     %ebx,%esi
	            if (pn == PGNUM(UXSTACKTOP - PGSIZE)) {
  800fe7:	81 fe ff eb 0e 00    	cmp    $0xeebff,%esi
  800fed:	0f 84 c1 00 00 00    	je     8010b4 <fork+0x123>
	                continue;
	            }
  ...
  800ffc:	0f 84 b2 00 00 00    	je     8010b4 <fork+0x123>
	// uvpt+pn==(0xef401000){
	// 	cprintf("\n\nHERE\n\n");
	...
	if(pn==979969)
  801002:	81 fe 01 f4 0e 00    	cmp    $0xef401,%esi
  801008:	75 0c                	jne    801016 <fork+0x85>
		cprintf("\n\nHAHA\n\n");
  80100a:	c7 04 24 ec 17 80 00 	movl   $0x8017ec,(%esp)
  801011:	e8 50 f2 ff ff       	call   800266 <cprintf>
  ...
  80101d:	25 02 08 00 00       	and    $0x802,%eax
	if(pn==979969)
		cprintf("\n\nHAHA\n\n");
	...
	int perm = PTE_P|PTE_U;
  801022:	83 f8 01             	cmp    $0x1,%eax
  801025:	19 ff                	sbb    %edi,%edi
  801027:	81 e7 00 f8 ff ff    	and    $0xfffff800,%edi
  ...
  801036:	89 7c 24 10          	mov    %edi,0x10(%esp)
  80103a:	89 74 24 0c          	mov    %esi,0xc(%esp)
  80103e:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801041:	89 44 24 08          	mov    %eax,0x8(%esp)
  801045:	89 74 24 04          	mov    %esi,0x4(%esp)
  801049:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801050:	e8 a2 fc ff ff       	call   800cf7 <sys_page_map>
  801055:	85 c0                	test   %eax,%eax
  801057:	79 1c                	jns    801075 <fork+0xe4>
		panic("ERROR in page map system call.");
  801059:	c7 44 24 08 74 18 80 	movl   $0x801874,0x8(%esp)
  801060:	00 
  801061:	c7 44 24 04 54 00 00 	movl   $0x54,0x4(%esp)
  801068:	00 
  801069:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  801070:	e8 f8 f0 ff ff       	call   80016d <_panic>

	if(sys_page_map(envid, (void*)(pn*PGSIZE), 0, (void*)(pn*PGSIZE), perm))
  801075:	89 7c 24 10          	mov    %edi,0x10(%esp)
  801079:	89 74 24 0c          	mov    %esi,0xc(%esp)
  ...
  80108f:	e8 63 fc ff ff       	call   800cf7 <sys_page_map>
  801094:	85 c0                	test   %eax,%eax
  801096:	74 1c                	je     8010b4 <fork+0x123>
		panic("ERROR in page map system call.");
  801098:	c7 44 24 08 74 18 80 	movl   $0x801874,0x8(%esp)
  80109f:	00 
  8010a0:	c7 44 24 04 57 00 00 	movl   $0x57,0x4(%esp)
  8010a7:	00 
  8010a8:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  8010af:	e8 b9 f0 ff ff       	call   80016d <_panic>
	    {
	        // No page table yet.
	        if (!(uvpd[i] & PTE_P))
	            continue;
	        ...
	        for (j=0;j<NPTENTRIES;j++) 
  8010b4:	83 c3 01             	add    $0x1,%ebx
  8010b7:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
  8010bd:	0f 85 1f ff ff ff    	jne    800fe2 <fork+0x51>
	envid_t pid = sys_exofork();
	...
	if(pid>0)		//parent
	{
		int i,j;
	    for (i=0;i<PDX(UTOP);i++) 
  8010c3:	83 45 dc 01          	addl   $0x1,-0x24(%ebp)
  8010c7:	81 7d dc bb 03 00 00 	cmpl   $0x3bb,-0x24(%ebp)
  8010ce:	0f 85 ee fe ff ff    	jne    800fc2 <fork+0x31>
	            if (uvpt[pn] & PTE_P)
	                duppage(pid, pn);
	        }
	    }
  ...
  8010d4:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  8010db:	00 
  8010dc:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  8010e3:	ee 
  8010e4:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8010e7:	89 04 24             	mov    %eax,(%esp)
  8010ea:	e8 b4 fb ff ff       	call   800ca3 <sys_page_alloc>
  8010ef:	85 c0                	test   %eax,%eax
  8010f1:	79 1c                	jns    80110f <fork+0x17e>
	    	panic("fork: no phys mem for xstk");
  8010f3:	c7 44 24 08 f5 17 80 	movl   $0x8017f5,0x8(%esp)
  8010fa:	00 
  8010fb:	c7 44 24 04 8b 00 00 	movl   $0x8b,0x4(%esp)
  801102:	00 
  801103:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  80110a:	e8 5e f0 ff ff       	call   80016d <_panic>
  ...
  80111b:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80111e:	89 04 24             	mov    %eax,(%esp)
  801121:	e8 ca fc ff ff       	call   800df0 <sys_env_set_pgfault_upcall>
  801126:	85 c0                	test   %eax,%eax
  801128:	74 1c                	je     801146 <fork+0x1b5>
	        panic("fork: cannot set pgfault upcall");
  80112a:	c7 44 24 08 94 18 80 	movl   $0x801894,0x8(%esp)
  801131:	00 
  801132:	c7 44 24 04 8f 00 00 	movl   $0x8f,0x4(%esp)
  801139:	00 
  80113a:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  801141:	e8 27 f0 ff ff       	call   80016d <_panic>

	    // Step 5: set child status to ENV_RUNNABLE.
	    if (sys_env_set_status(pid, ENV_RUNNABLE))
  801146:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  80114d:	00 
  80114e:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801151:	89 04 24             	mov    %eax,(%esp)
  801154:	e8 44 fc ff ff       	call   800d9d <sys_env_set_status>
  801159:	85 c0                	test   %eax,%eax
  80115b:	74 3a                	je     801197 <fork+0x206>
	        panic("fork: cannot set env status");
  80115d:	c7 44 24 08 10 18 80 	movl   $0x801810,0x8(%esp)
  801164:	00 
  801165:	c7 44 24 04 93 00 00 	movl   $0x93,0x4(%esp)
  80116c:	00 
  80116d:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  801174:	e8 f4 ef ff ff       	call   80016d <_panic>
	    return pid;
  ...
  801179:	e8 e7 fa ff ff       	call   800c65 <sys_getenvid>
		thisenv = &envs[ENVX(self_id)];		
  80117e:	25 ff 03 00 00       	and    $0x3ff,%eax
  801183:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801186:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80118b:	a3 08 20 80 00       	mov    %eax,0x802008
		return 0;
  801190:	b8 00 00 00 00       	mov    $0x0,%eax
  801195:	eb 03                	jmp    80119a <fork+0x209>
	    ...
	    return pid;
  801197:	8b 45 d8             	mov    -0x28(%ebp),%eax
		return 0;
	}
...
sfork(void)
{
  ...
  8011a8:	c7 44 24 08 2c 18 80 	movl   $0x80182c,0x8(%esp)
  8011af:	00 
  8011b0:	c7 44 24 04 a7 00 00 	movl   $0xa7,0x4(%esp)
  8011b7:	00 
  8011b8:	c7 04 24 e1 17 80 00 	movl   $0x8017e1,(%esp)
  8011bf:	e8 a9 ef ff ff       	call   80016d <_panic>

008011c4 <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8011ca:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  8011d1:	75 3c                	jne    80120f <set_pgfault_handler+0x4b>
		// First time through!
		// LAB 4: Your code here.
  ...
  8011db:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  8011e2:	00 
  8011e3:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  8011ea:	ee 
  8011eb:	89 04 24             	mov    %eax,(%esp)
  8011ee:	e8 b0 fa ff ff       	call   800ca3 <sys_page_alloc>
  8011f3:	85 c0                	test   %eax,%eax
  8011f5:	78 20                	js     801217 <set_pgfault_handler+0x53>
			return;
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  8011f7:	a1 08 20 80 00       	mov    0x802008,%eax
  8011fc:	8b 40 48             	mov    0x48(%eax),%eax
  8011ff:	c7 44 24 04 19 12 80 	movl   $0x801219,0x4(%esp)
  801206:	00 
  801207:	89 04 24             	mov    %eax,(%esp)
  80120a:	e8 e1 fb ff ff       	call   800df0 <sys_env_set_pgfault_upcall>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  80120f:	8b 45 08             	mov    0x8(%ebp),%eax
  801212:	a3 0c 20 80 00       	mov    %eax,0x80200c
}
  801217:	c9                   	leave  
  801218:	c3                   	ret    
...
_pgfault_upcall:
  ...
  80122b:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	movl %ebx, (%eax)		// trap-time eip pushed onto trap-time stack
  80122f:	89 18                	mov    %ebx,(%eax)
