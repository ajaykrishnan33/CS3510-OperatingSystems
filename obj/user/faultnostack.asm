...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003e9:	c7 04 24 58 11 80 00 	movl   $0x801158,(%esp)
  ...
  8003ff:	e8 51 00 00 00       	call   800455 <vcprintf>
	cprintf("\n");
  800404:	c7 04 24 7c 11 80 00 	movl   $0x80117c,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e33:	75 3c                	jne    800e71 <set_pgfault_handler+0x4b>
		// First time through!
		// LAB 4: Your code here.
  ...
  800e57:	78 20                	js     800e79 <set_pgfault_handler+0x53>
			return;
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800e59:	a1 04 20 80 00       	mov    0x802004,%eax
  800e5e:	8b 40 48             	mov    0x48(%eax),%eax
  800e61:	c7 44 24 04 97 03 80 	movl   $0x800397,0x4(%esp)
  800e68:	00 
  800e69:	89 04 24             	mov    %eax,(%esp)
  800e6c:	e8 5e f4 ff ff       	call   8002cf <sys_env_set_pgfault_upcall>
	}
