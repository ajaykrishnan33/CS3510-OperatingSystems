...
sys_env_destroy(envid_t envid)
{
  ...
  800b88:	e8 d6 02 00 00       	call   800e63 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c1a:	e8 44 02 00 00       	call   800e63 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c6d:	e8 f1 01 00 00       	call   800e63 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cc0:	e8 9e 01 00 00       	call   800e63 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d13:	e8 4b 01 00 00       	call   800e63 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d66:	e8 f8 00 00 00       	call   800e63 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800ddb:	e8 83 00 00 00       	call   800e63 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800df5:	75 3c                	jne    800e33 <set_pgfault_handler+0x4b>
		// First time through!
  ...
  800e19:	78 20                	js     800e3b <set_pgfault_handler+0x53>
			return;
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800e1b:	a1 04 20 80 00       	mov    0x802004,%eax
  800e20:	8b 40 48             	mov    0x48(%eax),%eax
  800e23:	c7 44 24 04 3d 0e 80 	movl   $0x800e3d,0x4(%esp)
  800e2a:	00 
  800e2b:	89 04 24             	mov    %eax,(%esp)
  800e2e:	e8 ed fe ff ff       	call   800d20 <sys_env_set_pgfault_upcall>
	}
...
_pgfault_upcall:
  ...
  800e3e:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e68:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800e6b:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e6e:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e74:	e8 1c fd ff ff       	call   800b95 <sys_getenvid>
  ...
  800e87:	89 74 24 08          	mov    %esi,0x8(%esp)
  800e8b:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e8f:	c7 04 24 f4 13 80 00 	movl   $0x8013f4,(%esp)
  800e96:	e8 f6 f2 ff ff       	call   800191 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e9b:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e9f:	8b 45 10             	mov    0x10(%ebp),%eax
  800ea2:	89 04 24             	mov    %eax,(%esp)
  800ea5:	e8 86 f2 ff ff       	call   800130 <vcprintf>
	cprintf("\n");
  800eaa:	c7 04 24 7a 11 80 00 	movl   $0x80117a,(%esp)
  800eb1:	e8 db f2 ff ff       	call   800191 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800eb6:	cc                   	int3   
  800eb7:	eb fd                	jmp    800eb6 <_panic+0x53>
